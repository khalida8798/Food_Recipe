...
import kotlinx.android.synthetic.main.activity_add_update_record_2.*


class AddUpdateRecordActivity_d : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_add_update_record_2)
        ...
        if (isEditMode){
            ...
            if(imageUri.toString() == "null") {
                cimage_d.setImageResource(R.drawable.image2)
            }
            else{
                cimage_d.setImageURI(imageUri)
            }
            step_d.setText(steps)
            ingredient_d.setText(ingredients)
            recipename_d.setText(name)
        }
        else{
        ...
        cimage_d.setOnClickListener {
            imagePickDialog()
        }

        done_d.setOnClickListener {
            inputData()
        }
    ...
    private fun inputData() {
        name = "" + recipename_d.text.toString().trim()
        ingredients = "" + ingredient_d.text.toString().trim()
        steps = "" + step_d.text.toString().trim()
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == IMAGE_PICK_GALLERY_CODE) {
            ...
            if (resultCode == Activity.RESULT_OK){
                ...
                imageUri = resultUri
                cimage_d.setImageURI(resultUri)
            }
